...
#print(data)
#graph_walltime_vs_runtime(data)

graph_walltime_vs_runtime_marginal_distributions_compared(data)
graph_walltime_vs_runtime_ratio_histogram(data)
graph_walltime_vs_runtime_expzoom_ratio_histogram(data,by=0.01)
graph_walltime_vs_runtime_heatmap(data,binwidth=c(100, 100),xlimits=c(0,100000),ylimits=c(0,100000))
graph_walltime_vs_runtime_heatmap(data,binwidth=c(1000, 1000),xlimits=c(0,200000),ylimits=c(0,200000))
graph_walltime_vs_runtime_heatmap(data,binwidth=c(7000, 7000),xlimits=c(0,200000),ylimits=c(0,200000))
graph_walltime_vs_runtime_heatmap_log10scale(data,binwidth=c(0.3, 0.3),xlimits=c(0,6),ylimits=c(0,6))
graph_walltime_vs_runtime_heatmap_log10scale(data,binwidth=c(0.1, 0.1),xlimits=c(0,6),ylimits=c(0,6))
